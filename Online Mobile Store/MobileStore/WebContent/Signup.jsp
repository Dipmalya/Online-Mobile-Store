...
<%@ page import="com.Login.SignupServlet" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Hello User || Sign Up</title>
...
<img src="images/images.jpg" style="position:absolute; left: 166px; top: 499px; width: 141px; height: 123px;"/><img src="images/download.jpg" width="171" style="position:absolute; left: 166px; top: 220px; height: 127px; width: 141px;" /><img src="images/download.png" width="167" style="position:absolute; left: 166px; top: 366px; width: 141px; height: 113px;"/>
	<form id="form1" name="form1" method="post" action="SignupServlet" onsubmit="return valid()">
	<table width="200" border="0" class="tab10">
      <tr class="tr10">
        <td height="46">First Name </td>
        <td>:</td>
        <td><label>
          <input type="text" name="textfield8" style="font-size:18px"/>
          </label>
		</td>
      </tr>
      <tr class="tr10">
        ...
        <td width="308">
          <label>
          <input type="text" name="textfield" style="font-size:18px"/>
          </label>       </td>
      </tr>
	  <tr class="tr10">
	  	<td>Password</td>
		...
		<td>
		<label>
		<input type="password" name="textfield7" style="font-size:18px"/>
	  </label>	  </tr>
      <tr class="tr10">
        ...
        <td>
          <label>
            <input type="text" name="textfield2" style="font-size:18px"/>
          </label>       </td>
      </tr>
      <tr class="tr10">
        ...
        <td>
          <label></label>
          <textarea name="textarea" style="font-size:18px; height:80px"></textarea>       </td>
      </tr>
      <tr class="tr10">
        <td>Email</td>
        <td>:</td>
        <td>
          <label>
            <input type="text" name="textfield3" style="font-size:18px"/>
          </label>        </td>
      </tr>
      <tr class="tr10">
        <td>City</td>
        ...
        <td>
          <label>
            <input type="text" name="textfield4" style="font-size:18px"/>
          </label>        </td>
      </tr>
      <tr class="tr10">
        ...
        <td>
          <label>
            <input type="text" name="textfield5" style="font-size:18px" />
          </label>        </td>
      </tr>
      <tr class="tr10">
        <td>PIN code </td>
        ...
        <td>
          <label>
            <input type="text" name="textfield6" style="font-size:18px"/>
          </label>        </td>
      </tr>
</table>
<input type="submit" name="Submit" value="Create Account" class="kola"/>
</form>
	<p class="tunamax" style="text-decoration:none; font-size:28px;">Sign Up</p>
</body>
</html>
...
public void setupConnection(PreparedStatement mySmt) throws Exception{
	try{
...
checkuser = true;
	...
	mySmt = (PreparedStatement)session.getAttribute("statement");
	setupConnection(mySmt);
...
<% do{ check=false;%>
<tr>
<% for(k=1;(k<=3)&&myRs.next();k++) { check=true;%>
